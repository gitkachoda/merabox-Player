...
class INLINE:
    START_BTN = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(TEXT.DEVELOPER, url="https://t.me/Bhootterimc")],
            [
                InlineKeyboardButton(TEXT.UPDATES_CHANNEL, url="https://t.me/teraboxKaVideoDekhogeBabu_bot"),
                InlineKeyboardButton(TEXT.SOURCE_CODE, url="https://t.me/teraboxKaVideoDekhogeBabu_bot"),
            ],
        ]
    )
